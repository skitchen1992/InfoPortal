...
export const getArticleDetailsIsLoading = (state: AppState) => state.articleDetails?.isLoading;
export const getArticleDetailsError = (state: AppState) => state.articleDetails?.error;
export const getArticleDetailsHasData = (state: AppState) => state.articleDetails?.hasData;
